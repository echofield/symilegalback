...
export const BOND_PRICING = {
  ...
  types: [
    { id: 'service', name: 'Prestation de service', description: 'Pour missions de conseil, développement, design, marketing...', icon: '' },
    { id: 'travaux', name: 'Travaux', description: 'Construction, rénovation, aménagements...', icon: '' },
    { id: 'creation', name: 'Création artistique', description: 'Design, illustration, musique, vidéo...', icon: '' },
    { id: 'event', name: 'Événementiel', description: 'Organisation événements, traiteur, location matériel...', icon: '' },
  ],
};
